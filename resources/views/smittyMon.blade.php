...
<meta property="og:description" content="{{ ucwords($mon->name) }}; {{ $mon->ab1->name }} / {{ $mon->ab2->name }} / {{ $mon->ha->name }}; Requires: {{ $items }}">
<meta property="og:image" content="https://pokevoid.wiki/cFront:{{ $mon->name }}.png">
@endpush
            ...
            <div class="card mb-3">
                ...
                <div id="tab-stats" class="tab-panel active">
                    <p style="font-size:12px;color:var(--muted);margin-bottom:14px">
                        Glitched stats · BST <strong style="color:var(--text)">{{ $mon->bst }}</strong>
                    </p>
