...
<meta property="og:description" content="{{ $mon->name }}; Ability 1: {{ $mon->ab1->name }}; Ability 2: {{ $mon->ab2->name }}; HA: {{ $mon->ha->name }}; Glitch of {{ $mons }}; Requires: {{ $items }}">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3"><p class="mb-0">SMITTY Pokemon</p></div>
                        <div class="col-sm-9"><p class="text-muted mb-0">{{ $mons }}</p></div>
                    </div>
                    <hr>
                    <div class="row">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="card mb-4">
                        <div class="card-body">
                            <p class="mb-4">
                                <span class="text-primary font-italic">smitty</span>
