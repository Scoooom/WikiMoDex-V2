...
<meta property="og:description" content="{{ ucwords($mon->name) }}; Ability 1: {{ $mon->ab1->name }}; Ability 2: {{ $mon->ab2->name }}; HA: {{ $mon->ha->name }}; Glitch of {{ $mons }}">
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <h5 class="my-3">{{ ucwords($mon->name) }}</h5>
